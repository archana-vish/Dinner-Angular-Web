...
//var ca = [new Buffer(config.ca_certificate_base64, 'base64')];

var db = mongoose.connection;
/* FOR COMPOSE FOR MONGODB OVER SSL
var options = {
    mongos: {
        sslValidate: false
    }
...
*/
// Let's open that connection for compose for mongodb
//mongoose.connect(config.mongoUrl, options);

// Let's open that connection for mongodb
mongoose.connect(config.mongoUrl);
